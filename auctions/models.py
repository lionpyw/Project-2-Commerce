...
class AuctionListings(models.Model):
    ...
    bidwinner = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True)
...
class Comments(models.Model):
    ...
    user = models.ForeignKey(User,on_delete=models.CASCADE, related_name='commentry')
